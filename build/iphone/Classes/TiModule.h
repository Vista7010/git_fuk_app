...
/**
 The base class for all fuk_app modules
 */
...
/**
 fuk_app Platform calls this method on startup.
 */
-(void)startup;

/**
 fuk_app Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 fuk_app Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 fuk_app Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 fuk_app Platform calls this method on resume.
 @param sender The sender of the event.
 */
