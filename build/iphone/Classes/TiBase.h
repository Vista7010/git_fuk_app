...
// in simulator we redefine to format for fuk_app Developer console
...
{\
	NSString * exceptionName = [@"org.fuk_app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fuk_app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIfuk_appNativeItemNone = -1, 
	UIfuk_appNativeItemSpinner = -2,
	UIfuk_appNativeItemProgressBar = -3,
	
	UIfuk_appNativeItemSlider = -4,
	UIfuk_appNativeItemSwitch = -5,
	UIfuk_appNativeItemMultiButton = -6,
	UIfuk_appNativeItemSegmented = -7,
	
	UIfuk_appNativeItemTextView = -8,
	UIfuk_appNativeItemTextField = -9,
	UIfuk_appNativeItemSearchBar = -10,
	
	UIfuk_appNativeItemPicker = -11,
	UIfuk_appNativeItemDatePicker = -12,
	
	UIfuk_appNativeItemInfoLight = -13,
	UIfuk_appNativeItemInfoDark = -14,
	
	UIfuk_appNativeItemDisclosure = -15,
	
	UIfuk_appNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all fuk_app instances of
