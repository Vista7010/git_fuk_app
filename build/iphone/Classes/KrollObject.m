 ...
 * Copyright (c) 2009-2011 by fuk_app, Inc. All Rights Reserved.
...
//@interface fuk_appObject : NSObject
//@end

@interface fuk_appObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[fuk_appObject class]])
		{
			for (NSString *key in [[(fuk_appObject*)o modules] allKeys])
			{
