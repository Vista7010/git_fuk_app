...
static NSString * const kfuk_appJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_fuk_appInjection
{
	...
	[html appendString:kfuk_appJavascript];
...
{
	// attempt to make well-formed HTML and inject in our fuk_app bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _fuk_appInjection]];
